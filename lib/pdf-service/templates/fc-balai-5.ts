/**
 * FC Balai 5 (Field Calibration — Balai Besar MKG Wilayah V) template configuration.
 *
 * Uses Balai 5 specific header (name, address, logo) with FC format.
 */
...
const balai = BALAI_DATA[5]

export const fcBalai5Template: TemplateConfig = {
  type: 'fc_balai_5',
