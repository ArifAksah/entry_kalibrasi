/**
 * FC Balai 1 (Field Calibration — Balai Besar MKG Wilayah I) template configuration.
 *
 * Uses Balai 1 specific header (name, address, logo) with FC format.
 */
...
const balai = BALAI_DATA[1]

export const fcBalai1Template: TemplateConfig = {
  type: 'fc_balai_1',
