/**
 * LC Balai 5 (Lab Calibration — Balai Besar MKG Wilayah V) template configuration.
 *
 * Uses Balai 5 specific header (name, address, logo) with LC format.
...
export const lcBalai5Template: TemplateConfig = {
  type: 'lc_balai_5',
