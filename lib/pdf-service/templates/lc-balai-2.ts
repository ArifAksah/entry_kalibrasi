/**
 * LC Balai 2 (Lab Calibration — Balai Besar MKG Wilayah II) template configuration.
 *
 * Uses Balai 2 specific header (name, address, logo) with LC format.
...
export const lcBalai2Template: TemplateConfig = {
  type: 'lc_balai_2',
