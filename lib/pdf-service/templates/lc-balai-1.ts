/**
 * LC Balai 1 (Lab Calibration — Balai Besar MKG Wilayah I) template configuration.
 *
 * Uses Balai 1 specific header (name, address, logo) with LC format.
...
export const lcBalai1Template: TemplateConfig = {
  type: 'lc_balai_1',
