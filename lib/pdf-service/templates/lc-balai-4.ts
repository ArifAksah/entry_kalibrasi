/**
 * LC Balai 4 (Lab Calibration — Balai Besar MKG Wilayah IV) template configuration.
 *
 * Uses Balai 4 specific header (name, address, logo) with LC format.
...
export const lcBalai4Template: TemplateConfig = {
  type: 'lc_balai_4',
