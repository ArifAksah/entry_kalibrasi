/**
 * FC Balai 2 (Field Calibration — Balai Besar MKG Wilayah II) template configuration.
 *
 * Uses Balai 2 specific header (name, address, logo) with FC format.
 */
...
const balai = BALAI_DATA[2]

export const fcBalai2Template: TemplateConfig = {
  type: 'fc_balai_2',
