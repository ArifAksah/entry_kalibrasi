/**
 * FC Balai 3 (Field Calibration — Balai Besar MKG Wilayah III) template configuration.
 *
 * Uses Balai 3 specific header (name, address, logo) with FC format.
 */
...
export const fcBalai3Template: TemplateConfig = {
  type: 'fc_balai_3',
