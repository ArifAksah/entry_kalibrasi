 ...
 * Output: public/templates/fc-cover-template-v2.docx
 *         public/templates/fc-results-template-v2.docx
 */
...
async function main() {
  ...
  const coverPath = path.join(dir, 'fc-cover-template-v2.docx')
  ...
  const resultsPath = path.join(dir, 'fc-results-template-v2.docx')
