  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const certificatesData = Array.isArray(certData)
          ? certData
          : (certData?.data ?? [])
        ...
        const stationsData = Array.isArray(stationData)
          ? stationData
          : (stationData?.data ?? [])
        ...
        const instrumentsData = Array.isArray(instrumentData)
          ? instrumentData
          : (instrumentData?.data ?? [])
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    Tabel dan header ini didesain berdasarkan referensi gambar
                    yang diberikan, dengan mengadopsi gaya visual, struktur
                    kolom, dan elemen UI yang serupa.
                  </p>
                </div>
              </div>
            </div>
