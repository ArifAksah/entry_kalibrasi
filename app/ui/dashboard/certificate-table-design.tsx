...
const StatusButton: React.FC<{
  status: string
  type: 'verifikator' | 'penandatangan' | 'kirim' | 'berkas'
}> = ({ status, type }) => {
...
const ActionIcons: React.FC<{ certificate: Certificate }> = ({
  certificate,
}) => {
  return (
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold mb-2">
              Daftar Log Sertifikat Kalibrasi
            </h1>
            <p className="text-blue-100">
              Pembuatan Sertifikat Kalibrasi / Log Sertifikat Kalibrasi
            </p>
          </div>
            ...
            <tr>
              ...
              <th className="px-4 py-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFilterChange('tanggal_naskah', e.target.value)
                  }
                />
              </th>
              <th className="px-4 py-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFilterChange('nomor_naskah', e.target.value)
                  }
                />
              </th>
              <th className="px-4 py-2">
              ...
              <th className="px-4 py-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFilterChange('asal_naskah', e.target.value)
                  }
                />
              </th>
              <th className="px-4 py-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFilterChange('status_verifikator', e.target.value)
                  }
                >
              ...
              <th className="px-4 py-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFilterChange('status_penandatangan', e.target.value)
                  }
                >
                  <option value="">Semua</option>
                  <option value="belum">Belum</option>
              ...
              <th className="px-4 py-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFilterChange('status_kirim', e.target.value)
                  }
                >
                  <option value="">Semua</option>
                  <option value="belum">Belum</option>
              ...
              <th className="px-4 py-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFilterChange('status_berkas', e.target.value)
                  }
                >
                  <option value="">Semua</option>
            ...
            {certificates.map((cert, index) => (
              <tr key={cert.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-sm">
                  {' '}
                  <StatusButton
                    status={getStatusVerifikator(cert)}
                    type="verifikator"
                  />
                </td>
                <td className="px-4 py-3 text-sm">
                  {' '}
                  <StatusButton
                    status={getStatusPenandatangan(cert)}
                    type="penandatangan"
                  />
                </td>
                <td className="px-4 py-3 text-sm">
      ...
      <div className="bg-gray-50 px-4 py-3 border-t border-gray-200">
        <div className="flex items-center justify-between">
          <div className="text-sm text-gray-700">
            Menampilkan 1 sampai {certificates.length} dari{' '}
            {certificates.length} entri
          </div>
          <div className="flex items-center space-x-2">
