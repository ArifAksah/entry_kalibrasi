...
const SideNav: React.FC = () => {
            ...
            <div key={i}>
              ...
              <ul className="space-y-1">
                {[...Array(3)].map((_, j) => (
                  <li
                    key={j}
                    className="h-8 bg-slate-700/50 rounded animate-pulse"
                  ></li>
                ))}
              </ul>
            </div>
  ...
  return (
    <aside
      ...
      className="h-screen sticky top-0 bg-gradient-to-b from-slate-800 to-blue-900 border-r border-slate-700 flex flex-col w-64 shadow-2xl"
    >
